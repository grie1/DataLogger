...
void logData() {
  ...
  float arrayReadings[] = { readings_BME280.getTempF(), readings_BME280.getHumidity(), readings_BME280.getPressure(), readings_MCP9808.getTempF(), 
                          ...
                          readings_mpl115a2.getTempF(), readings_mpl115a2.getPressure(), readings_SCD30.getTempF(), readings_SCD30.getHumidity(),
                          readings_SCD30.getCO2() };

 dataString += now.unixtime();
 dataString += ",";
 
 for (byte i = 0; i < 13; i = i+1) {
